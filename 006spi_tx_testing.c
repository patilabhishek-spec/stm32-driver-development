 ...
 */
	...
	//	GPIO_Init(&SPIPins);
	 ...
	 void SPI2_Inits(void)
	 {
		 ...
		 SPI2handle.SPIConfig.SPI_SclkSpeed= SPI_SCLK_SPEED_DIV2;//GENARATES THE CLOCK OF 8MHZ
		 SPI2handle.SPIConfig.SPI_DFF =SPI_DFF_8BITS;
		 SPI2handle.SPIConfig.SPI_CPOL =SPI_CPOL_LOW;
		 SPI2handle.SPIConfig.SPI_CPHA  =SPI_CPHA_LOW;
		 SPI2handle.SPIConfig.SPI_SSM= SPI_SSM_EN; //SOFTWERE SLAVE MANAGMENT ENABLED FOR NSS
		...
		int main(void)
		{
			...
			//THIS MAKE NSS SIGNAL INTERNALLY HIGH AND AVOIDS MODEF ERROR
