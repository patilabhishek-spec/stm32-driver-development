...
//comfiguration strcuture for USARTx peripheral
...
//handle strcuture for USARTx peripheral
...
#define USART_EVENT_RXNE   5
#define USART_EVENT_TC     6
#define USART_EVENT_TXE    7
#define USART_EVENT_LBD    8
#define USART_EVENT_CTS    9


#define USART_EVENT_TX_CMPLT     0
#define USART_EVENT_RX_CMPLT     1

#define USART_ERREVENT_FE        3
#define USART_ERREVENT_NE        4
#define USART_ERREVENT_ORE       5
